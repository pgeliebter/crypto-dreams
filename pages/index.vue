                  ...
                  <li class="nav-item">
                    ...
                    >
                      <li class="sidebar-item">
                        <a class="sidebar-link" href="index.html">E-commerce</a>
                      </li>
                      <li class="sidebar-item">
                        <a class="sidebar-link" href="index-analytics.html">
                          Analytics
                        </a>
                      </li>
                    </ul>
                ...
                <div class="col-12 col-lg-7 col-xl-8 mb-4">
                  <div class="position-relative card h-100">
                    <div
                      ...
                      "
                    >
                      <h6 class="pe-3 mb-0">Overview</h6>
                ...
                <div class="col-lg-5 col-xl-4 mb-4">
                  <div class="card h-100 overflow-hidden">
                    <div
                      ...
                      "
                    >
                      <h6 class="pe-3 mb-0">Visitors</h6>
                      <!--Select Period of data showing-->
                      <div class="width-140">
                        <select
                          class="form-control form-control-sm"
